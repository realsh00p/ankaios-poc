...
IMAGE_DIR="${IMAGE_DIR:-/home/linaro/ankaios_research/qemu_1}"
WORK_DIR="${WORK_DIR:-/home/linaro/ankaios_research/qemu_1/work}"
...
CONTAINERS_MOUNT_TAG="${CONTAINERS_MOUNT_TAG:-qemu_1_var_lib_containers}"
VIRTIOFSD="${VIRTIOFSD:-/usr/lib/qemu/virtiofsd}"
VIRTIOFSD_SOCKET="${VIRTIOFSD_SOCKET:-/run/qemu_1-containers.sock}"
ETC_CONTAINERS_HOST_DIR="${ETC_CONTAINERS_HOST_DIR:-$IMAGE_DIR/etc/containers}"
ETC_CONTAINERS_MOUNT_TAG="${ETC_CONTAINERS_MOUNT_TAG:-qemu_1_etc_containers}"
ETC_ANKAIOS_HOST_DIR="${ETC_ANKAIOS_HOST_DIR:-$IMAGE_DIR/etc/ankaios}"
ETC_ANKAIOS_MOUNT_TAG="${ETC_ANKAIOS_MOUNT_TAG:-qemu_1_etc_ankaios}"
VM_MEMORY="${VM_MEMORY:-256M}"
VM_CPUS="${VM_CPUS:-2}"
SSH_HOST_PORT="${SSH_HOST_PORT:-2201}"
ECHO_HOST_PORTS="${ECHO_HOST_PORTS:-40101 40102 40103}"
SSH_KEY="${SSH_KEY:-/home/linaro/ankaios_research/qemu_1/alpine-podman_ed25519}"
...
insecure = true
runtimes = [ 'podman' ]
tags = { 'host' = 'linaro', 'vm' = 'qemu_1', 'arch' = 'aarch64' }
EOF
