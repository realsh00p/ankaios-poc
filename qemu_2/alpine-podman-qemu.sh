...
IMAGE_DIR="${IMAGE_DIR:-/home/linaro/ankaios_research/qemu_2}"
WORK_DIR="${WORK_DIR:-/home/linaro/ankaios_research/qemu_2/work}"
...
SSH_KEY="${SSH_KEY:-/home/linaro/ankaios_research/qemu_2/alpine-podman_ed25519}"
